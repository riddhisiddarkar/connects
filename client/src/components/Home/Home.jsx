...
import spraypaint from "../../assets/images/spraypaint.png";
  ...
  return (
    <main>
      ...
      <div className={styles.optns}>
        {options.map((ele, i) => (
          <div
            className={styles.op}
            key={i}
            style={{ backgroundImage: `url(${spraypaint})` }}
          >
            ...
            <Link to={`/${ele.button_link}`} className={styles.btns}>
              {ele.button_title}
            </Link>
          </div>
        ))}
      ...
      <div
        ...
        style={{ backgroundImag: `url(${shadedbackground})` }}
      >
        <img
          src={HoldingHeart}
          alt="HoldingHeart"
        ...
        <div className={styles.abt_info}>
          ...
          <div className={styles.btns}>Learn More</div>
        </div>
      </div>
      <div className={styles.reach}>
        {nos.map((ele, i) => (
          <div
            className={styles.r}
            style={{ backgroundImage: `url(${Untitled2})` }}
            key={{ i }}
          >
            <p>{ele.no}</p>
            <span>{ele.title}</span>
